...
namespace Telegram.Bot.Examples.WebHook
{
    ...
    {
        public static readonly TelegramBotClient Api = new TelegramBotCl¸ient("735679555:AAG5IR2zfVNKTjtSiDuk0_DlXYnhiofSkOw");
    }
    ...
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (WebApp.Start<Startup>("https://+:80"))
            {
                // Register WebHook
                // You should replace {YourHostname} with your Internet accessible hosname
                Bot.Api.SetWebhookAsync("https://{e59caca5.ngrok.io}:80/WebHook").Wait();
